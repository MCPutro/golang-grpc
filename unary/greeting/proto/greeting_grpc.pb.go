...
func (c *greetingServiceClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetingResponse, error) {
...
func (UnimplementedGreetingServiceServer) Greet(context.Context, *GreetRequest) (*GreetingResponse, error) {
